...
public class OrchestratorStatus {
    ...
    public String toString() {
        String statusBarMsg =
            "Total services: %d " + "  Submited: %d" + "  Running: %d" + "  Successful: %d" + "  Failed: %d";
        return String.format(statusBarMsg, this.totalServices, this.totalSubmitted, this.totalRunning,
                             this.totalSuccess, this.totalFailed);
    }
    ...
    public String toHTML() {
        ...
        String statusBarMsg =
            ("<html>" + "Total services: %d " + "  Submited:<font color=blue> %d </font>" + "  Running: %d" +
             "  Successful:<font color=green> %d</font>" + "  Failed: <font color=red> %d </font>" + "</html>");
        return String.format(statusBarMsg, this.totalServices, this.totalSubmitted, this.totalRunning,
                             this.totalSuccess, this.totalFailed);
    }
