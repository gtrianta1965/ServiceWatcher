...
public class Reporter {
    ...
    private void sendMail() {
        ...
        makeLog();
        // Mail Header
        final String[] recipients = this.configuration
                                        .getRecipients()
    ...
    private static BodyPart makeAttachment(String attachmentPath, String id) {
        ...
        InputStream stream =
            Reporter.class.getResourceAsStream(attachmentPath); //or null if you can't obtain a ServletContext
    ...
    private void makeLog() {
        ...
        for (ServiceParameter sp : this.serviceOrchestrator
                                       .getConfiguration()
            ...
            logKV.put("actual_retries",
                      Integer.toString(sp.getActualRetries()) == null ? "" : Integer.toString(sp.getActualRetries()));
